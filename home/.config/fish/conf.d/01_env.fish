...
set -gx PNPM_HOME ~/.local/share/pnpm/bin
set -gx XDG_CACHE_HOME ~/.cache
set -gx XDG_CONFIG_HOME ~/.config
set -gx XDG_DATA_HOME ~/.local/share
set -gx XDG_STATE_HOME ~/.local/state

fish_add_path -g -m ~/bin ~/.local/bin ~/.nix-profile/bin /run/wrappers/bin /run/current-system/sw/bin /nix/var/nix/profiles/default/bin "$PNPM_HOME" "$HOME/.cargo/bin" /opt/homebrew/bin /opt/homebrew/sbin
