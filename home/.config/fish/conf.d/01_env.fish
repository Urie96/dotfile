...
fish_add_path -g -m ~/bin ~/.local/bin ~/.local/state/nix/profile/bin /run/wrappers/bin /run/current-system/sw/bin /nix/var/nix/profiles/default/bin "$PNPM_HOME" /opt/homebrew/bin /opt/homebrew/sbin
