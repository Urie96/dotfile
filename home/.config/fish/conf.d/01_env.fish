...
fish_add_path -g -m ~/bin ~/.local/bin ~/.nix-profile/bin /run/wrappers/bin /run/current-system/sw/bin /nix/var/nix/profiles/default/bin "$PNPM_HOME/bin" /opt/homebrew/bin /opt/homebrew/sbin
